...
<div align="center">
 ...
 <table style="width:600px;" class="table">
	    ...
	    <tr align="center">
		   <td>${ dto.seq }</td>
		    <td>
		       ...
		       <a  href="/jspPro/board/content.do?seq=${ dto.seq }&searchCondition=${ searchCondition }&searchWord=${searchWord }&currentPage=${currentPage}"    class="subjectLink title">	      
		  			${ dto.title }  
		       	</a>
		    </td>
		    <td> 
  ...
  <a href="/jspPro/board/write.do">글쓰기</a><br>
</div>
