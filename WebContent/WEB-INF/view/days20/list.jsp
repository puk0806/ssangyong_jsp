...
<head>
<meta charset="UTF-8">
<title>jsp/servlet class - k≡n¡k (2019. 5. 16.-오후 4:34:12)</title>
		 ...
		 <tr class="data">
		   ...
		   <td>
		     <c:if test="${ dto.depth gt 0 }">
		       ...
		       <img src="/jspPro/days20/replyboard/images/arr.gif" alt="" />
		     </c:if>
		     ...
		     <c:if test="${ dto.newImg }">
		       <img src="/jspPro/days20/replyboard/images/ico-new.gif" alt="" />
		     </c:if>
		   </td>
		   <td>
		     <c:if test="${ dto.writer eq 'kenik' }">
		       <img src="/jspPro/days20/replyboard/images/star.gif" alt="" />
		     </c:if>
