...
import days19.article.service.WriteArticleService;
import days19.article.service.WriteRequest;
...
public class WriteArticleHandler implements CommandHandler {
	...
	private String processSubmit(HttpServletRequest req, HttpServletResponse res) {
		...
		// sendRediect("~~/list.do")
		return "/days18/article/newArticleSuccess";
	}
