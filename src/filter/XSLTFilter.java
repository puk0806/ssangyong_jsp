...
// @WebFilter(filterName = "xsltFilter", urlPatterns = { "/days14/xml/*" })	// 필터 걸어주는 urlPattern
public class XSLTFilter implements Filter {

	private String xslPath = null;		// 스타일 주는 경로 변수

	@Override
	public void init(FilterConfig config) throws ServletException {
		xslPath = config.getServletContext().getRealPath("/WEB-INF/view/xsl/book.xsl");
	}
